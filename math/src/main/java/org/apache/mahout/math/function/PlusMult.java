 ...
 * 根据不同转换,可以出现以下运算方式
 * <ul>
 * <li><tt>a + b*constant</tt> 原始定义
 * <li><tt>a - b*constant</tt> 只要把常量取负数即可 a + b*(-constant)
 * <li><tt>a + b/constant</tt> a + b * (1/constant),因此只要把常量取倒数即可
 * <li><tt>a - b/constant</tt> 把常量取负数,并且取倒数即可
 * </ul> 
